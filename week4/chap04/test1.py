...
def put_box(frame, pt1, pt2, color=(0, 0, 255), thickness=3):
    cv2.rectangle(frame, pt1, pt2, color, thickness)

    # 관심 영역에서 녹색 성분을 50만큼 증가
    frame[pt1[1] : pt2[1], pt1[0] : pt2[0], 1] += 50
...
while True:  # 무한 반복
    ...
    exposure = capture.get(cv2.CAP_PROP_EXPOSURE)  # 노출값 획득
    put_box(frame, (200, 100), (300, 300))
