...
image = cv2.imread("week4/chap07/images/filter_sharpen.jpg", cv2.IMREAD_GRAYSCALE)
if image is None:
...
sharpen1 = filter(image, mask1)  # 회선 수행 - 화소 직접 접근
sharpen2 = filter(image, mask2)  # 회선 수행
