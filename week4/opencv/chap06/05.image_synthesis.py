...
add_img2 = cv2.add(image1 * alpha, image2 * beta)  # 영상 합성
add_img2 = np.clip(add_img2, 0, 255).astype("uint8")  # 0~255 범위 제한
add_img3 = cv2.addWeighted(image1, alpha, image2, beta, 0)  # 영상 합성
